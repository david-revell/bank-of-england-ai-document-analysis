...
INPUT_FILE = "barclays_20_input_tau_0.75.jsonl"  # change as needed

# Generate timestamped output filenames
STAMP = datetime.now().strftime("%Y%m%d_%H%M%S")
OUTPUT_CSV = f"barclays_20_tau_075_ragas_results_{STAMP}.csv" # change as needed
OUTPUT_JSON = f"barclays_20_tau_075_ragas_results_{STAMP}.json" # change as needed
